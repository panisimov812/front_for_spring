...
const PanemComponent = message => {
        ...
        const [submitting, setSubmitting] = useState(false); // Состояние для отслеживания активности кнопки отправки
        ...
        const handleSubmit = async (event) => {
            ...
            setSubmitting(true); // Устанавливаем состояние отправки данных в true
            try {
            ...
            setTimeout(() => {
                setSubmitting(false); // Через 3 секунды устанавливаем состояние отправки данных обратно в false
            }, 6000);
        };
